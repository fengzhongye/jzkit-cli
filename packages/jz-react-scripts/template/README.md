This project was bootstrapped with [Create React App](https://github.com/fengzhongye/jzkit-cli).

Below you will find some information on how to perform common tasks.<br>
You can find the most recent version of this guide [here](https://github.com/fengzhongye/jzkit-cli/blob/master/packages/jzkit-react-scripts/template/README.md).
...
To update an existing project to a new version of `jzkit-react-scripts`, [open the changelog](https://github.com/fengzhongye/jzkit-cli/blob/master/CHANGELOG.md), find the version you’re currently on (check `package.json` in this folder if you’re not sure), and apply the migration instructions for the newer versions.

In most cases bumping the `jzkit-react-scripts` version in `package.json` and running `npm install` in this folder should be enough, but it’s good to consult the [changelog](https://github.com/fengzhongye/jzkit-cli/blob/master/CHANGELOG.md) for potential breaking changes.

We commit to keeping the breaking changes minimal so you can upgrade `jzkit-react-scripts` painlessly.

## Sending Feedback

We are always open to [your feedback](https://github.com/fengzhongye/jzkit-cli/issues).
...
* [JSX](https://fengzhongye.github.io/react/docs/introducing-jsx.html) and [Flow](https://flowtype.org/) syntax.
...
If you are using React Router check out [this tutorial](http://serverless-stack.com/chapters/code-splitting-in-jzkit-cli.html) on how to use code splitting with it. You can find the companion GitHub repository [here](https://github.com/AnomalyInnovations/serverless-stack-demo-client/tree/code-splitting-in-jzkit-cli).
...
Generally, we recommend that you don’t reuse the same CSS classes across different components. For example, instead of using a `.Button` CSS class in `<AcceptButton>` and `<RejectButton>` components, we recommend creating a `<Button>` component with its own `.Button` styles, that both `<AcceptButton>` and `<RejectButton>` can render (but [not inherit](https://fengzhongye.github.io/react/docs/composition-vs-inheritance.html)).
...
- Infinite styles compiling [#1939](https://github.com/fengzhongye/jzkit-cli/issues/1939)
...
To reduce the number of requests to the server, importing images that are less than 10,000 bytes returns a [data URI](https://developer.mozilla.org/en-US/docs/Web/HTTP/Basics_of_HTTP/Data_URIs) instead of a path. This applies to the following file extensions: bmp, gif, jpg, jpeg, and png. SVG files are excluded due to [#1153](https://github.com/fengzhongye/jzkit-cli/issues/1153).
...
// query.graphql
{
  githubStats(repository: "fengzhongye/react") {
    stars
  }
}
...
Here is an example of adding a [customized Bootstrap](https://medium.com/@tacomanator/customizing-jzkit-cli-aa9ffb88165) that follows these steps.
...
>Note: You must create custom environment variables beginning with `REACT_APP_`. Any other variables except `NODE_ENV` will be ignored to avoid accidentally [exposing a private key on the machine that could have the same name](https://github.com/fengzhongye/jzkit-cli/issues/865#issuecomment-252199527). Changing any environment variables will require you to restart the development server if it is running.
...
* [#214](https://github.com/fengzhongye/jzkit-cli/issues/214)
* [#411](https://github.com/fengzhongye/jzkit-cli/issues/411)
...
### Node
Check out [this tutorial](https://www.fullstackreact.com/articles/using-jzkit-cli-with-a-server/).
You can find the companion GitHub repository [here](https://github.com/fullstackreact/food-lookup-demo).

### Ruby on Rails

Check out [this tutorial](https://www.fullstackreact.com/articles/how-to-get-jzkit-cli-to-work-with-your-rails-api/).
...
This shouldn’t affect you when developing on `localhost`, but if you develop remotely like [described here](https://github.com/fengzhongye/jzkit-cli/issues/2271), you will see this error in the browser after enabling the `proxy` option:
...
>[Read the migration guide to learn how to enable it in older projects!](https://github.com/fengzhongye/jzkit-cli/blob/master/CHANGELOG.md#migrating-from-023-to-030)

Create React App uses [Jest](https://fengzhongye.github.io/jest/) as its test runner. To prepare for this integration, we did a [major revamp](https://fengzhongye.github.io/jest/blog/2016/09/01/jest-15.html) of Jest so if you heard bad things about it years ago, give it another try.
...
![Jest watch mode](http://fengzhongye.github.io/jest/img/blog/15-watch.gif)
...
All `expect()` matchers supported by Jest are [extensively documented here](https://fengzhongye.github.io/jest/docs/en/expect.html#content).<br>
You can also use [`jest.fn()` and `expect(fn).toBeCalled()`](https://fengzhongye.github.io/jest/docs/en/expect.html#tohavebeencalled) to create “spies” or mock functions.
...
All Jest matchers are [extensively documented here](http://fengzhongye.github.io/jest/docs/en/expect.html).<br>
...
We recommend that you use `expect()` for assertions and `jest.fn()` for spies. If you are having issues with them please [file those against Jest](https://github.com/fengzhongye/jest/issues/new), and we’ll fix them. We intend to keep making them better for React, supporting, for example, [pretty-printing React elements as JSX](https://github.com/fengzhongye/jest/pull/1566).
...
Supported overrides:
 - [`collectCoverageFrom`](https://fengzhongye.github.io/jest/docs/en/configuration.html#collectcoveragefrom-array)
 - [`coverageReporters`](https://fengzhongye.github.io/jest/docs/en/configuration.html#coveragereporters-array-string)
 - [`coverageThreshold`](https://fengzhongye.github.io/jest/docs/en/configuration.html#coveragethreshold-object)
 - [`snapshotSerializers`](https://fengzhongye.github.io/jest/docs/en/configuration.html#snapshotserializers-array-string)
...
>  If you find yourself doing this often in development, please [file an issue](https://github.com/fengzhongye/jzkit-cli/issues/new) to tell us about your use case because we want to make watcher the best experience and are open to changing how it works to accommodate more workflows.
...
* [`ReactDOM.render()`](https://fengzhongye.github.io/react/docs/top-level-api.html#reactdom.render)
* [`TestUtils.renderIntoDocument()`](https://fengzhongye.github.io/react/docs/test-utils.html#renderintodocument) ([a shortcut](https://github.com/fengzhongye/react/blob/34761cf9a252964abfaab6faf74d473ad95d1f21/src/test/ReactTestUtils.js#L83-L91) for the above)
* [`mount()`](http://airbnb.io/enzyme/docs/api/mount.html) in [Enzyme](http://airbnb.io/enzyme/index.html)

In contrast, **jsdom is not needed** for the following APIs:

* [`TestUtils.createRenderer()`](https://fengzhongye.github.io/react/docs/test-utils.html#shallow-rendering) (shallow rendering)
* [`shallow()`](http://airbnb.io/enzyme/docs/api/shallow.html) in [Enzyme](http://airbnb.io/enzyme/index.html)

Finally, jsdom is also not needed for [snapshot testing](http://fengzhongye.github.io/jest/blog/2016/07/27/jest-14.html).

### Snapshot Testing

Snapshot testing is a feature of Jest that automatically generates text snapshots of your components and saves them on the disk so if the UI output changes, you get notified without manually writing any assertions on the component output. [Read more about snapshot testing.](http://fengzhongye.github.io/jest/blog/2016/07/27/jest-14.html)
...
build directory. After running the build script, `jzkit-cli` will give
...
>Note: This is a [change in default behavior](https://github.com/fengzhongye/jzkit-cli/issues/3248),
as earlier versions of `jzkit-cli` shipping with `navigateFallback`
enabled by default.
...
See [this](https://medium.com/@to_pe/deploying-jzkit-cli-on-microsoft-azure-c0f6686a4321) blog post on how to deploy your React app to Microsoft Azure.

See [this](https://medium.com/@strid/host-jzkit-cli-on-azure-986bc40d5bf2#.pycfnafbg) blog post or [this](https://github.com/ulrikaugustsson/azure-appservice-static) repo for a way to use automatic deployment to Azure App Service.
...
IMPORTANT: you need to set proper HTTP caching headers for `service-worker.js` file in `firebase.json` file or you will not be able to see changes after first deployment ([issue #2440](https://github.com/fengzhongye/jzkit-cli/issues/2440)). It should be added inside `"hosting"` key like next:
...
Use the [Heroku Buildpack for Create React App](https://github.com/mars/jzkit-cli-buildpack).<br>
...
See this [blog post](https://medium.com/@omgwtfmarc/deploying-jzkit-cli-to-s3-or-cloudfront-48dae4ce0af) on how to deploy your React app to Amazon Web Services S3 and CloudFront.
...
REACT_EDITOR | :white_check_mark: | :x: | When an app crashes in development, you will see an error overlay with clickable stack trace. When you click on it, Create React App will try to determine the editor you are using based on currently running processes, and open the relevant source file. You can [send a pull request to detect your editor of choice](https://github.com/fengzhongye/jzkit-cli/issues/2636). Setting this environment variable overrides the automatic detection. If you do it, make sure your systems [PATH](https://en.wikipedia.org/wiki/PATH_(variable)) environment variable points to your editor’s bin folder. You can also set it to `none` to disable it completely.
...
* If the watcher doesn’t see a file called `index.js` and you’re referencing it by the folder name, you [need to restart the watcher](https://github.com/fengzhongye/jzkit-cli/issues/1164) due to a Webpack bug.
...
If none of these solutions help please leave a comment [in this thread](https://github.com/fengzhongye/jzkit-cli/issues/659).

### `npm test` hangs on macOS Sierra

If you run `npm test` and the console gets stuck after printing `jzkit-react-scripts test --env=jsdom` to the console there might be a problem with your [Watchman](https://fengzhongye.github.io/watchman/) installation as described in [fengzhongye/jzkit-cli#713](https://github.com/fengzhongye/jzkit-cli/issues/713).

We recommend deleting `node_modules` in your project and running `npm install` (or `yarn` if you use it) first. If it doesn't help, you can try one of the numerous workarounds mentioned in these issues:

* [fengzhongye/jest#1767](https://github.com/fengzhongye/jest/issues/1767)
* [fengzhongye/watchman#358](https://github.com/fengzhongye/watchman/issues/358)
...
You can find [other installation methods](https://fengzhongye.github.io/watchman/docs/install.html#build-install) on the Watchman documentation page.

If this still doesn’t help, try running `launchctl unload -F ~/Library/LaunchAgents/com.github.fengzhongye.watchman.plist`.
...
[Ejecting](#npm-run-eject) lets you customize anything, but from that point on you have to maintain the configuration and scripts yourself. This can be daunting if you have many similar projects. In such cases instead of ejecting we recommend to *fork* `jzkit-react-scripts` and any other packages you need. [This article](https://auth0.com/blog/how-to-configure-jzkit-cli/) dives into how to do it in depth. You can find more discussion in [this issue](https://github.com/fengzhongye/jzkit-cli/issues/682).

## Something Missing?

If you have ideas for more “How To” recipes that should be on this page, [let us know](https://github.com/fengzhongye/jzkit-cli/issues) or [contribute some!](https://github.com/fengzhongye/jzkit-cli/edit/master/packages/jzkit-react-scripts/template/README.md)
