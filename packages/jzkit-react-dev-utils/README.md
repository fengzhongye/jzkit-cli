...
This package includes some utilities used by [Create React App](https://github.com/fengzhongye/jzkit-cli).<br>
...
These utilities come by default with [Create React App](https://github.com/fengzhongye/jzkit-cli), which includes it by default. **You don’t need to install it separately in Create React App projects.**

## Usage Outside of Create React App

If you don’t use Create React App, or if you [ejected](https://github.com/fengzhongye/jzkit-cli/blob/master/packages/react-scripts/template/README.md#npm-run-eject), you may keep using these utilities. Their development will be aligned with Create React App, so major versions of these utilities may come out relatively often. Feel free to fork or copy and paste them into your projects if you’d like to have more control over them, or feel free to use the old versions. Not all of them are React-specific, but we might make some of them more React-specific in the future.
...
var InterpolateHtmlPlugin = require('jzkit-react-dev-utils/InterpolateHtmlPlugin');
...
```js
var path = require('path');
var ModuleScopePlugin = require('jzkit-react-dev-utils/ModuleScopePlugin');
...
See [#186](https://github.com/fengzhongye/jzkit-cli/issues/186) for details.

```js
var path = require('path');
var WatchMissingNodeModulesPlugin = require('jzkit-react-dev-utils/WatchMissingNodeModulesPlugin');
...
module.exports = {
  ...
  plugins: [
    ...
    // See https://github.com/fengzhongye/jzkit-cli/issues/186
...
```js
var path = require('path');
var checkRequiredFiles = require('jzkit-react-dev-utils/checkRequiredFiles');
...
```js
var clearConsole = require('jzkit-react-dev-utils/clearConsole');
...
```js
const eslintFormatter = require('jzkit-react-dev-utils/eslintFormatter');
...
} = require('jzkit-react-dev-utils/FileSizeReporter');
...
var formatWebpackMessages = require('jzkit-react-dev-utils/formatWebpackMessages');
...
```
  const printBuildError = require('jzkit-react-dev-utils/printBuildError')
  try {
    build()
  } catch(e) {
...
```
jzkit-cli
in /Users/developer/jzkit-cli
```

```js
var getProcessForPort = require('jzkit-react-dev-utils/getProcessForPort');
...
```js
var path = require('path');
var openBrowser = require('jzkit-react-dev-utils/openBrowser');
...
module.exports = {
  ...
  entry: [
    ...
    'jzkit-react-dev-utils/webpackHotDevClient',
    'src/index'
  ],
  // ...
}
...
```js
const getCSSModuleLocalIdent = require('jzkit-react-dev-utils/getCSSModuleLocalIdent');
