...
These tests are run by **mocha** (why not **jest**? See [this issue](https://github.com/fengzhongye/jest/issues/2288)) and the environments used are both `development` and `production`.
