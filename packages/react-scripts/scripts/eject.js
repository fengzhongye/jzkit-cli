...
const inquirer = require('jzkit-react-dev-utils/inquirer');
const spawnSync = require('jzkit-react-dev-utils/crossSpawn').sync;
const os = require('os');
  ...
  .then(answer => {
    ...
    if (paths.useYarn) {
      ...
      if (process.platform === 'win32') {
        // https://github.com/fengzhongye/jzkit-cli/pull/3806#issuecomment-357781035
