...
// Finally, pack jzkit-react-scripts.
...
const scriptsFileName = cp
  .execSync(`npm pack`, { cwd: path.join(packagesDir, 'jzkit-react-scripts') })
  .toString()
  .trim();
...
const craScriptPath = path.join(packagesDir, 'jzkit-cli', 'index.js');
cp.execSync(
