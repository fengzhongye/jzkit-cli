...
cd "$temp_app_path"
npx jzkit-cli --scripts-version=@latest test-app-dist-tag
...
cd "$temp_app_path"
npx jzkit-cli --scripts-version=1.0.17 test-app-version-number
...
cd "$temp_app_path"
npx jzkit-cli --use-npm --scripts-version=1.0.17 test-use-npm-flag
...
npx jzkit-cli --scripts-version=`date +%s` test-app-should-not-exist || true
...
# we will install a non-existing package to simulate a failed installataion.
npx jzkit-cli --scripts-version=`date +%s` test-app-should-remain || true
...
npx jzkit-cli test-app-nested-paths-t1/aa/bb/cc/dd
cd test-app-nested-paths-t1/aa/bb/cc/dd
yarn start --smoke-test

# Testing a path that does not exist
cd "$temp_app_path"
npx jzkit-cli test-app-nested-paths-t2/aa/bb/cc/dd
...
npx jzkit-cli test-app-nested-paths-t3/aa/bb/cc/dd
