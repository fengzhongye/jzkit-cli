...
* `jzkit-cli`
  ...
  * [#3355](https://github.com/facebook/jzkit-cli/pull/3355) Add preflight CWD check for npm to detect bad Windows setups. ([@gaearon](https://github.com/gaearon))
...
* User Guide
  ...
  * [#2392](https://github.com/facebook/jzkit-cli/pull/2392) Update `jest-enzyme` section. ([@luftywiranda13](https://github.com/luftywiranda13))
...
* `react-scripts`
  ...
  * [#1839](https://github.com/facebook/jzkit-cli/pull/1839) Resolve `localhost` when offline (Windows). ([@bunshar](https://github.com/bunshar))
...
* `react-scripts`
  ...
  * [#2058](https://github.com/facebook/jzkit-cli/pull/2058) Clarify `.eslintrc` effects. ([@luftywiranda13](https://github.com/luftywiranda13))
  * [#2054](https://github.com/facebook/jzkit-cli/pull/2054) Suggest to create `.eslintrc` for IDE lint plugins. ([@gaearon](https://github.com/gaearon))
  * [#2033](https://github.com/facebook/jzkit-cli/pull/2033) Fix Netlify heading level. ([@benpickles](https://github.com/benpickles))
  * [#1987](https://github.com/facebook/jzkit-cli/pull/1987) Suggest `node-sass` alternative. ([@michaelwayman](https://github.com/michaelwayman))
  * [#1988](https://github.com/facebook/jzkit-cli/pull/1988) Update doc server example to work from any directory. ([@isramos](https://github.com/isramos))
  * [#1982](https://github.com/facebook/jzkit-cli/pull/1982) Update information in User Guide for Enzyme dependency. ([@josephrace](https://github.com/josephrace))
  * [#1911](https://github.com/facebook/jzkit-cli/pull/1911) Suggest Yarn in HTML template. ([@tmos](https://github.com/tmos))
  * [#1869](https://github.com/facebook/jzkit-cli/pull/1869) User Guide: Removed blockquote from code section, due to markdown conflict. ([@stochris](https://github.com/stochris))
  ...
  * [#1717](https://github.com/facebook/jzkit-cli/pull/1717) Add docs for apache's client side routing setting. ([@viankakrisna](https://github.com/viankakrisna))
  ...
  * [#1657](https://github.com/facebook/jzkit-cli/pull/1657) Set Chrome userDataDir to be under .vscode folder. ([@ryansully](https://github.com/ryansully))
* Other
  * [#2135](https://github.com/facebook/jzkit-cli/pull/2135) Add note about `yarn.lock`. ([@viankakrisna](https://github.com/viankakrisna))
  * [#2040](https://github.com/facebook/jzkit-cli/pull/2040) Fix typo. ([@tijwelch](https://github.com/tijwelch))
...
* Other
  ...
  * [#1825](https://github.com/facebook/jzkit-cli/pull/1825) Added test to check for accidental extraneous dependencies. ([@lpalmes](https://github.com/lpalmes))
  * [#1876](https://github.com/facebook/jzkit-cli/pull/1876) Fix AppVeyor CI. ([@darrenscerri](https://github.com/darrenscerri))
